			...
			<div class="w3-container w3-padding-32" id="container">
				...
				<div class="w3-container">
					<div class="w3-bar w3-black">
						...
						<a href="#addemp"><button class="w3-bar-item w3-button tablink" onclick="operation(event, 'addemp')">Add Employee</button></a>
						<a href="#delemp"><button class="w3-bar-item w3-button tablink" onclick="operation(event, 'delemp')">Delete Employee</button></a>
						...
						<a href="#rooms"><button class="w3-bar-item w3-button tablink" onclick="operation(event, 'status')">Rooms Status</button></a>
						...
						<a href="#empanalysis"><button class="w3-bar-item w3-button tablink" onclick="operation(event, 'emp')">Employee Analysis</button></a>
					</div>
					...
					<div id="addemp" class="w3-container w3-border tabs" style="display:none">
						<h2 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center"><b>Add Employee</b></h2>
						<form action="addemp.php" method="post">
							...
							<select class="w3-select w3-border" name="gender">
								<option value="" disabled selected class="w3-light-grey">Gender</option>
								<option value="1">Male</option>
								<option value="2">Female</option>
							</select>
							<input class="w3-input w3-section w3-border" type="number" min="18" placeholder="Age" required name="age">
							<input class="w3-input w3-section w3-border" type="text" placeholder="Contact Number" required name="number">
							<input class="w3-input w3-section w3-border" type="date" placeholder="Date Of Admission" required name="doa">
							<input class="w3-input w3-section w3-border" type="text" placeholder="Designation" required name="desig">
							<select class="w3-select w3-border w3-section" name="dept">
								<option value="" disabled selected>Choose Department</option>
								<option value="D102">Front Office</option>
								<option value="D103">House Keeping</option>
								<option value="D104">Purchasing & Store</option>
								<option value="D105">Room Service</option>
								<option value="D106">Security</option>
							</select>
							<input class="w3-input w3-section w3-border" type="number" placeholder="Salary" required name="salary">
							<button class="w3-button w3-black w3-section" type="submit">
							<i class="fa fa-paper-plane"></i> Submit
							</button>
						</form>
					</div>
					<div id="delemp" class="w3-container w3-border tabs" style="display:none">
						<h2 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center"><b>Delete Employee</b></h2>
						<form action="delemp.php" method="post">
							<input class="w3-input w3-border" type="text" placeholder="Employee ID" required name="id">
							<input class="w3-input w3-section w3-border" type="text" placeholder="Employee Full Name" required name="name">
							<button class="w3-button w3-black w3-section" type="submit">
					...
					<div id="status" class="w3-container w3-border tabs" style="display:none">
						<h2 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center"><b>Room Status</b></h2>
						<?php      
					...
					<div id="emp" class="w3-container w3-border tabs" style="display:none">
						<h2 class="w3-border-bottom w3-border-light-grey w3-padding-16 w3-center"><b>Employee Analysis</b></h2>
						<form action="analysis.php" method="post" target="_blank">
							<select class='w3-select w3-border w3-section' name='dept'>
								<option value='' disabled selected>Choose Department</option>
							<?php
